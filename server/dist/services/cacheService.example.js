 ...
 */
import cacheService, { CacheKeyGenerator, CacheTTL, getTTLForDataType } from './cacheService.js';
// ============================================================================
// EXAMPLE 1: Caching NWS Points Data (24 hours)
// ============================================================================
async function fetchPointsData(lat, lon) {
...
// ============================================================================
async function fetch7DayForecast(office, gridX, gridY) {
...
// ============================================================================
async function fetchCurrentObservations(stationId) {
...
// ============================================================================
function cacheWithAutoTTL(dataType, key, value) {
...
// ============================================================================
function invalidateForecastCache(office, gridX, gridY) {
...
//# sourceMappingURL=cacheService.example.js.map